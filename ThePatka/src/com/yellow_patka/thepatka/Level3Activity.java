...
public class Level3Activity extends Activity implements OnClickListener{
	...
	int[] patka = new int[2];
	int c = 0;
	String level_txt ="Level 3";
	static boolean[] status = { false, false, false, false, false, false, false};
	static int counter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back = (Button) findViewById(R.id.lvl_3_backBtn);
		back.setOnClickListener(this);
		submit = (Button) findViewById(R.id.lvl_3_submitBtn);
		submit.setOnClickListener(this);
		level = (TextView) findViewById(R.id.lvl_3_Level);
		line1 = (TextView) findViewById(R.id.lvl_3_line1);
		line2 = (TextView) findViewById(R.id.lvl_3_line2);
		line3 = (TextView) findViewById(R.id.lvl_3_line3);
		line4 = (TextView) findViewById(R.id.lvl_3_line4);
		line5 = (TextView) findViewById(R.id.lvl_3_line5);
		line6 = (TextView) findViewById(R.id.lvl_3_line6);
		line7 = (TextView) findViewById(R.id.lvl_3_line7);
		level.setText(level_txt);
		line1.setText("#include <iostream>");
		line2.setText("int main(){ ");
		line3.setText("	int i=0.6;");
		line4.setText("	unsigned short x = 50;");
		line5.setText("	cout << "+"x is:"+"<<i<< endl");
		line6.setText("return 0;");
		line7.setText("}");	
	...
	public void onClick(View v) {
		if(v.getId() == back.getId()){
			...
			patka[1]=4;
			Arrays.sort(answer);
			if((Arrays.equals(answer, patka)) && counter==2){
